...
| `gh-workflows-ref`     | Git reference to checkout shared-workflows repository      | No       | `bugfix/rpm-builds`             |
...
jobs:
  upload:
    uses: aerospike/shared-workflows/.github/workflows/reusable_deploy-artifacts.yaml@bugfix/rpm-builds
    with:
      jf-project: database
